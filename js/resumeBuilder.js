var bio = {
  ...
  "welcomeMessage": "Welcome to the Hugo's resume site.",
  "skills": [
    "CSS",
    "HTML",
    "Javascript",
  ...
  HTMLcontactGeneric = formattedMobile + formattedEmail + formattedTwiter + formattedGithub + formattedblog + formattedlocation;
...
var education = {
 ...
 "OnlineCourses": [
  ...
  var formattedName = HTMLonlineSchool.replace("%data%", education.OnlineCourses[online].school);
  var formattedNameTitle = formattedTitle + formattedName;
  $(".education-entry:last").append(formattedNameTitle);
...
var projects = {
  "projects":[
  {
     ...
     "dates": "01/07 - 06-12",
     "description": "Personal webpage for myself",
